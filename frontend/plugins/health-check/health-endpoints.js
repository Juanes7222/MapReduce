...
function setupHealthEndpoints(devServer, healthPlugin) {
  if (!devServer || !devServer.app) {
    console.warn('[Health Check] Servidor de desarrollo no disponible, se omiten los endpoints de salud');
    return;
  }

  if (!healthPlugin) {
    console.warn('[Health Check] Plugin de salud no proporcionado, se omiten los endpoints de salud');
    return;
  }

  console.log('[Health Check] Configurando endpoints de salud...');
  ...
  console.log('[Health Check] ✓ Endpoints de salud listos:');
  console.log('  • GET /health         - Estado detallado');
  console.log('  • GET /health/simple  - OK/ERROR simple');
  console.log('  • GET /health/ready   - Verificación de disponibilidad');
  console.log('  • GET /health/live    - Verificación de actividad');
  console.log('  • GET /health/errors  - Detalles de errores');
  console.log('  • GET /health/stats   - Estadísticas');
}
